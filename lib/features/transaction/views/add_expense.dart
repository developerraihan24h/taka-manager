              ...
              children: [
                ...
                Container(
                  ...
                  child: Consumer<CategoryProvider>(
                    builder: (context, provider, child) {
                      final incomeCategories = provider.getByType("expense");
                ...
                uiHelper.customButton(
                  callback: () async {
                    ...
                    if (selectedAccountId == null ||
                        selectedCategoryId == null|| AmountController.text.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Select amount, account & category")),
                      );
                      return;
                    }
                    ...
                    // 1️⃣ Save Transaction as EXPENSE
                    ...
                    // 2️⃣ Subtract from Account Balance
                    await context.read<AccountProvider>()
